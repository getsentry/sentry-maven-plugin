...
- Bump Sentry SDK from v8.13.2 to v8.15.0 ([#162](https://github.com/getsentry/sentry-maven-plugin/pull/162))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8150)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.13.2...8.15.0)
