...
- Bump Sentry SDK from v8.34.1 to v8.56.0 ([#282](https://github.com/getsentry/sentry-maven-plugin/pull/282))
  - [changelog](https://github.com/getsentry/sentry-java/blob/9.x.x main/CHANGELOG.md#8560)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.34.1...8.56.0)
