...
- Bump Sentry SDK from v8.34.1 to v8.51.0 ([#275](https://github.com/getsentry/sentry-maven-plugin/pull/275))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8510)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.34.1...8.51.0)
