...
- Bump CLI from v3.3.0 to v3.4.0 ([#246](https://github.com/getsentry/sentry-maven-plugin/pull/246))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#340)
  - [diff](https://github.com/getsentry/sentry-cli/compare/3.3.0...3.4.0)
