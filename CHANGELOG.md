...
- Bump CLI from v3.3.0 to v3.4.1 ([#248](https://github.com/getsentry/sentry-maven-plugin/pull/248))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#341)
  - [diff](https://github.com/getsentry/sentry-cli/compare/3.3.0...3.4.1)
