...
- Bump CLI from v2.47.0 to v2.51.1 ([#177](https://github.com/getsentry/sentry-maven-plugin/pull/177))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2511)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.47.0...2.51.1)
