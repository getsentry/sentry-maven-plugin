...
- Bump CLI from v3.3.0 to v3.7.0 ([#280](https://github.com/getsentry/sentry-maven-plugin/pull/280))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#370)
  - [diff](https://github.com/getsentry/sentry-cli/compare/3.3.0...3.7.0)
