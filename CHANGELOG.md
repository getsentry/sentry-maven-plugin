...
- Bump Sentry SDK from v8.34.1 to v8.39.1 ([#245](https://github.com/getsentry/sentry-maven-plugin/pull/245))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8391)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.34.1...8.39.1)
