...
- Bump Sentry SDK from v8.34.1 to v8.38.0 ([#243](https://github.com/getsentry/sentry-maven-plugin/pull/243))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8380)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.34.1...8.38.0)
