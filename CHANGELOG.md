...
- Bump Sentry SDK from v8.34.1 to v8.47.0 ([#267](https://github.com/getsentry/sentry-maven-plugin/pull/267))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8470)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.34.1...8.47.0)
