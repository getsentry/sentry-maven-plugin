...
- Bump Sentry SDK from v7.8.0 to v7.12.0 ([#78](https://github.com/getsentry/sentry-maven-plugin/pull/78), [#79](https://github.com/getsentry/sentry-maven-plugin/pull/79))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#7120)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...7.12.0)
