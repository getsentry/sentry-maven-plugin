...
- Bump Sentry SDK from v8.34.1 to v8.40.0 ([#247](https://github.com/getsentry/sentry-maven-plugin/pull/247))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.34.1...8.40.0)
