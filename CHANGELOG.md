...
- Bump Sentry SDK from v8.34.1 to v8.44.1 ([#261](https://github.com/getsentry/sentry-maven-plugin/pull/261))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8441)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.34.1...8.44.1)
