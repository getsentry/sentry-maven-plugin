...
- Bump CLI from v3.3.0 to v3.3.5 ([#242](https://github.com/getsentry/sentry-maven-plugin/pull/242))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#335)
  - [diff](https://github.com/getsentry/sentry-cli/compare/3.3.0...3.3.5)
