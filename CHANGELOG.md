...
- Bump Sentry SDK from v7.3.0 to v7.4.0 ([#55](https://github.com/getsentry/sentry-maven-plugin/pull/55))
...
- Bump CLI from v2.28.6 to v2.29.1 ([#57](https://github.com/getsentry/sentry-maven-plugin/pull/57))
