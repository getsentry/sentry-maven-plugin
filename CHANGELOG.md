...
- Bump Sentry SDK from v8.34.1 to v8.57.0 ([#284](https://github.com/getsentry/sentry-maven-plugin/pull/284))
  - [changelog](https://github.com/getsentry/sentry-java/blob/emdash/investigate-epitaph-jjewh emdash/sentry-buddy-new-features-fo8ny main/CHANGELOG.md#8570)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.34.1...8.57.0)
...
- Bump Sentry SDK from v8.26.0 to v8.34.1 ([#205](https://github.com/getsentry/sentry-maven-plugin/pull/205), [#211](https://github.com/getsentry/sentry-maven-plugin/pull/211), [#218](https://github.com/getsentry/sentry-maven-plugin/pull/218), [#231](https://github.com/getsentry/sentry-maven-plugin/pull/231))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8341)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.26.0...8.34.1)
- Bump CLI from v2.58.2 to v3.3.0 ([#208](https://github.com/getsentry/sentry-maven-plugin/pull/208), [#229](https://github.com/getsentry/sentry-maven-plugin/pull/229))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#330)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.58.2...3.3.0)

## 0.10.0

### Dependencies

- Bump Sentry SDK from v8.22.0 to v8.26.0 ([#202](https://github.com/getsentry/sentry-maven-plugin/pull/202))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8260)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.22.0...8.26.0)
- Bump CLI from v2.54.0 to v2.58.2 ([#201](https://github.com/getsentry/sentry-maven-plugin/pull/201))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2582)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.54.0...2.58.2)
