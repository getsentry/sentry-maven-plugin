...
- Bump Sentry SDK from v8.34.1 to v8.48.0 ([#269](https://github.com/getsentry/sentry-maven-plugin/pull/269))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8480)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.34.1...8.48.0)
