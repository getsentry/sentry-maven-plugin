...
- Bump Sentry SDK from v8.34.1 to v8.42.0 ([#251](https://github.com/getsentry/sentry-maven-plugin/pull/251))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8420)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.34.1...8.42.0)
