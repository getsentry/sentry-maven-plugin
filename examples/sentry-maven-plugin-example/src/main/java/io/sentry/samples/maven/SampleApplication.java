package io.sentry.samples.maven;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Sentry.init(
                options -> {
                    ...
                    options.setDsn(
                            "https://7b2b9423651340e7a50baac9cd0711fd@o447951.ingest.sentry.io/4504842527309824");
        ...
        System.out.println(Sentry.getCurrentHub().getOptions().getBundleIds());
